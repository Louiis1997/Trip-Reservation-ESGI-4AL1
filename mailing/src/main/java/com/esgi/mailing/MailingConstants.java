...
public class MailingConstants {
    ...
    public static final String MAILING_GENERATED_MONTHLY_BILL_TOPIC_NAME = "generated_monthly_bill_topic";
    public static final String MAILING_CONTRACT_STATUS_UPDATED_TOPIC = "contract_status_updated_topic";
